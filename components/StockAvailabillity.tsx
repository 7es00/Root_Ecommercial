...
const StockAvailabillity = ({ stock, inStock } : { stock: number, inStock: boolean }) => {
  return (
    ...
    { inStock ? <span className='text-success flex items-center gap-x-1'>In stock <FaCheck /></span> :  <span className='text-error flex items-center gap-x-1'>Out of stock <FaXmark /></span>}
